...
#define   APP_TASK_TO_CLIENT_MUTEX_PRIO                     11
#define   APP_TASK_FROM_CLIENT_MUTEX_PRIO                   12
#define   APP_TASK_ECU_MUTEX_PRIO                           13
#define   APP_TASK_CLIENT_RESPONSE_PRIO    (OS_LOWEST_PRIO - 7)
#define   APP_TASK_CLIENT_PARSER_PRIO      (OS_LOWEST_PRIO - 6)
